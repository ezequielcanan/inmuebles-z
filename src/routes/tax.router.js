import { createTax, getTaxes, updateTax, deleteTax, getActualTax, getMonthTax } from "../controllers/tax.controller.js";
...
export default class TaxRouter extends Z_Router {
  init() {
    ...
    this.get("/date", ["ADMIN", "BANK", "USER", "EXECUTIVE", "SECRETARY"], getMonthTax)
