      ...
      {floor ? (
        <>
          <section className="flex justify-between items-center w-full">
            <Link to={"/projects/" + floor.project._id}><FaChevronLeft className="text-6xl text-fourth" /></Link>
            <h1 className="text-fourth text-6xl">{floor?.project?.title} - {floor.title}</h1>
