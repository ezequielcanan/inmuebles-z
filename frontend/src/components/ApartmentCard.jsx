...
const ApartmentCard = ({apartment, edit=false}) => {
  return (
    <Link to={`/inmueble/${apartment._id}${edit ? "/edit" : ""}`} className={`${apartment.forSale ? "bg-fifth" : "bg-red-500"} flex flex-col items-center py-6 px-3 h-[250px] w-[200px]`}>
